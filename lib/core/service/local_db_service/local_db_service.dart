...
class DatabaseHelper {
  ...
  _initDatabase() async {
    ...
    ''');
        ...
        // ------- tags table ------- //
        // NOTE: TABLE_TAGS is created before TABLE_VIRTUAL_ENTRIES and TABLE_TRANSACTIONS
        // so that their FKs referencing TAG_ID are valid.
        await db.execute('''
...
''');
  ...
  Future<int> updateTransactionTag({
    ...
    try {
      ...
      return await db.update(
        TABLE_TRANSACTIONS,
        {TXN_TAG_ID: newTagId, UPDATED_AT: DateTime.now().toIso8601String()},
